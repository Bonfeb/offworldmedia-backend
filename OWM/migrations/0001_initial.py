# Generated by Django 5.0.3 on 2025-07-04 15:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('unpaid', 'Unpaid'), ('paid', 'Paid'), ('completed', 'Completed'), ('cancelled', 'Cancelled')], default='unpaid', max_length=10)),
        ...
        migrations.AddField(
            model_name='booking',
            name='service',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='OWM.service'),
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
